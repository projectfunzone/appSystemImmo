monApp
		...
		.controller(
				...
				function($scope, locationProvider) {
					...
					$scope.msg = "";
					$scope.get = function() {
						// appel de la fonction du locationProvider afin
						// de
								...
								.getS(
										...
										function(donnees) {
											if (typeof donnees == 'object') {
												...
												$scope.indice = false;
												$scope.msg = "L'habitation en location que vous recherchez n'est pas répertorié dans nos fichiers"
											}
										})
					};
				...
				function($scope, locationProvider, $location, $rootScope) {
					...
					$scope.update = function() {
						...
						locationProvider.updates($scope.locIn,
								function(donnees) {
